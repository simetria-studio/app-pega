...
@section('content')
    <div class="my-8">
        ...
        <div class="mx-10 grid grid-cols-2 gap-8 grid-rows-2 text-center text-white text-sm">
            <a class="rounded-2xl border-red-900 bg-red-900 p-4 w-full" href="/animais/asininos/semen">
                <img class="mx-auto h-20" src="{{ asset('img/caval-semen.png') }}" alt="" />
                Inscrição para doador de sêmen
            </a>

            <a class="rounded-2xl border-red-900 bg-red-900 p-4 w-full" href="/animais/asininos/embriao">
                <img class="mx-auto h-20" src="{{ asset('img/caval-embriao.png') }}" alt="" />
                Inscrição para doadora de embrião
            </a>


            <a class="rounded-2xl border-red-900 bg-red-900 p-4 w-full" href="/animais/asininos/pelagem">
