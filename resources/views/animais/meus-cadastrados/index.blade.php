        ...
        <div class="card rounded-lg mx-5 my-4 bg-zinc-100 drop-shadow-2xl">
            ...
            <div class="card-galery">
                <div class="grid grid-cols-3 gap-3 p-3">
                    <img class="rounded-lg" src="{{ asset('img/avatar-1.png') }}" alt="" />
                    <img class="rounded-lg" src="{{ asset('img/avatar-2.png') }}" alt="" />
                    <img class="rounded-lg" src="{{ asset('img/avatar-3.png') }}" alt="" />
                </div>
