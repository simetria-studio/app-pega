<template>
    <div class="my-8">
        ...
        <div class="mx-10 grid  grid-cols-2 grid-rows-3  gap-8 text-center text-white text-xs">
            <nuxt-link to="cobricao/asinino" class="rounded-2xl border-red-400 bg-red-900 p-4 w-full">
                <img class="mx-auto  my-2 w-16 h-16" src="~/assets/img/burro.png" alt="">
                Asinino
            </nuxt-link>
