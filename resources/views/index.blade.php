    ...
    <div class="my-10">
        ...
        <div class="mx-10 grid  grid-cols-2 grid-rows-3  gap-8 text-center text-white text-xs">
            <a href="{{ url('/pessoas') }}" class="rounded-2xl border-red-400 bg-red-900 p-4 w-full ">
                <img class="mx-auto my-2 w-16 h-16" src="{{ asset('img/pessoas.png') }}" alt="" />
                Pessoas
            </a>
            <a href="{{ url('/animais') }}" class="rounded-2xl border-red-400 bg-red-900 p-4 w-full ">
                <img class="mx-auto my-2 w-16 h-16" src="{{ asset('img/burro.png') }}" alt="" />
                Animais
            </a>
            <a href="{{ url('/financeiro') }}" class="rounded-2xl border-red-400 bg-red-900 p-4 w-full ">
                <img class="mx-auto my-2 w-16 h-16" src="{{ asset('img/financeiro.png') }}" alt="" />
                Financeiro
            </a>
            <a href="{{ url('/resenha') }}" class="rounded-2xl border-red-400 bg-red-900 p-4 w-full ">
                <img class="mx-auto my-2 w-16 h-16" src="{{ asset('img/resenha.png') }}" alt="" />
                Resenha
            </a>
            <a href="{{ url('/configuracoes') }}" class="rounded-2xl border-red-400 bg-red-900 p-4 w-full ">
                <img class="mx-auto my-2 w-16 h-16" src="{{ asset('img/config.png') }}" alt="" />
                Configurações
            </a>
            <a href="{{ url('/comunicacoes') }}" class="rounded-2xl border-red-400 bg-red-900 p-4 w-full ">
                <img class="mx-auto my-2 w-16 h-16" src="{{ asset('img/comunicacao.png') }}" alt="" />
                Comunicações
            </a>
        </div>
    </div>
