...
@section('content')
    <div class="my-8">
        ...
        <div class="my-8">
            <a href="/">
                <img src="{{ asset('img/home.png') }}" alt="Logotipo da ABCJPega" class="mx-auto w-32" />
            </a>
            <div class="text-center text-lg font-lg font-medium mt-3">
                <p>
        ...
        <div class="mx-10">
            <form action="" class="space-y-3 w-72 mx-auto mb-5">
                <p class="text-base font-medium text-center  mb-3">buscar por:</p>
                <div>
                    <input
            ...
            <div class="mb-5 flex justify-center">
                <button
                    class="w-32 h-9  text-white bg-red-900 rounded-2xl shadow-lg focus:bg-red-800 hover:shadow-red-900/25"
                    type="submit">
                    Buscar
                </button>
            </div>
